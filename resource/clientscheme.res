...
Scheme
{
	...
	Colors
	{
		...
		"Ammo In Clip"							"244 244 230 255"
		"Ammo In Reserve"						"244 244 230 255"
		"Ammo In Clip Low"						"255 42 130 255"
		"Ammo In Reserve Low"					"255 155 155 255"
		
		//refers to watching stvs/killcam shots
		"Spec Health Normal"					"244 244 230 255"
		"Spec Health Buff"						"40 190 255 255"			
		"Spec Health Hurt"						"244 244 230 255"
		
		//alternate colors for flashing values
		"Alternate Spec Health Normal"						"235 226 202 255"
		"Alternate Spec Health Buff"						"0 138 243 255"			
		"Alternate Spec Health Hurt"						"255 153 0 255"
		
		//refers to player health/targetids
		"Health Normal"							"244 244 230 255"
		"Health Buff"							"40 190 255 255"
		"Health Hurt"							"244 244 230 255"
		
		//alternate colors for flashing values
		"Alternate Health Normal"						"235 226 202 255"
		"Alternate Health Buff"						"0 138 243 255"			
		...
		//"Ubercharge Amount"						"244 244 230 255" // disabled temporarily; currently controlled by ammo in clip color
	
		"Heal Numbers"							"100 255 100 255"
		"Damage Numbers"						"255 255 0 255"
		
		//'Last DamageHeal Info' refers to the number that appears above hp
		"Last DamageHeal Info"					"254 254 240 255"
		
		//Menu/Color scheme colors
		"Base Color"				"244 244 230 255"
		"Button Color"				"97 242 189 255"	
		
		"Inactive Tab"				"114 114 100 255"	
		
		"StatBar1"						"168 115 230 128"
		"StatBar2"						"149 102 204 128"
		"StatBar3"						"130 89 179 128"
		"StatBar4"						"112 77 153 128"
		"StatBar5"						"93 64 128 128"
		"StatBar6"						"75 51 102 128"
		"StatBar7"						"56 38 77 128"
		"StatBar8"						"37 26 51 128"
		"StatBar9"						"19 13 26 128"
		...
		"HUDBlueTeam"		"102 153 255 127"
		"HUDRedTeam"		"255 102 102 127"
		"HUDSpectator"		"124 124 124 127"
		"HUDBlueTeamSolid"	"102 153 255 255"
		"HUDRedTeamSolid"	"255 102 102 255"
	...
	BaseSettings
	{
		...
		Econ.Button.PresetDefaultColorFg					"97 242 189 255"
		Econ.Button.PresetArmedColorFg						"97 242 189 255"
		Econ.Button.PresetDepressedColorFg					"97 242 189 255"
